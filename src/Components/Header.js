  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/" className="text-3xl font-extrabold text-gradient bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
        Naveena Sahu
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <li className="pb-1 md:pb-0">
            <NavLink to="/certificates" onClick={toggleClass}>
              Certifications
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
          ...
          <li>
            <a href={linkdein} target="_blank" rel="noreferrer noopener">
              <svg
                ...
                viewBox="0 0 30 30"
                fill="none"
                xmlns="http://www.linkedin.com/in/telukalanaveenasahu/"
              >
          ...
          <li>
            <a href={github} target="_blank" rel="noreferrer noopener">
              <svg
                ...
                viewBox="0 0 30 30"
                fill="none"
                xmlns="https://github.com/Navee-lab/"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
